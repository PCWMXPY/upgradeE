...
exports.lcid = exports.getLicenseFiles = exports.bundledLanguages = undefined;
...
let getLicenseFiles = exports.getLicenseFiles = (() => {
    var _ref = (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* (packager) {
        ...
        return files.map(function (file) {
            ...
            return { file: _path.join(packager.buildResourcesDir, file), lang, langWithRegion, langName: langIdToName[lang] };
        });
    });
...
const bundledLanguages = exports.bundledLanguages = ["en_US", "de_DE", "fr_FR", "es_ES", "zh_CN", "zh_TW", "ja_JP", "it_IT", "nl_NL", "ru_RU", "pl_PL", "uk_UA", "cs_CZ", "sv_SE", "nb_NO", "da_DK", "pt_PT"];
