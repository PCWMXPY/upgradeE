...
declare module "electron-builder/out/fileTransformer" {
  ...
  export function createTransformer(srcDir: string, extraMetadata: any): Promise<FileTransformer>
...
declare module "electron-builder/out/asarUtil" {
  ...
  import { FileTransformer, Filter } from "electron-builder-util/out/fs"

  export class AsarPackager {
    private readonly src
    private readonly options
    private readonly unpackPattern
    private readonly transformer
    private readonly fs
    private readonly outFile
    private transformedFiles
    private readonly metadata
    constructor(src: string, destination: string, options: AsarOptions, unpackPattern: Filter | null, transformer: FileTransformer)
    pack(filter: Filter, isElectronCompile: boolean): Promise<void>
    compileUsingElectronCompile(files: Array<string>): Promise<Array<string>>
    detectUnpackedDirs(files: Array<string>, autoUnpackDirs: Set<string>, unpackedDest: string): Promise<void>
    createPackageFromFiles(files: Array<string>): Promise<void>
    private writeAsarFile(files)
    private order(filenames)
  }
...
declare module "electron-builder/out/fileMatcher" {
  import { PlatformSpecificBuildOptions } from "electron-builder-core"
  import { Filter } from "electron-builder-util/out/fs"
  import { Minimatch } from "minimatch"
  ...
  export class FileMatcher {
    ...
    private normalizePattern(pattern)
  ...
  export function createFileMatcher(info: BuildInfo, appDir: string, resourcesPath: string, macroExpander: (pattern: string) => string, platformSpecificBuildOptions: PlatformSpecificBuildOptions, buildResourceDir: string): FileMatcher
...
declare module "electron-builder/out/packager/dirPackager" {
  ...
  export function unpackElectron(packager: PlatformPackager<any>, out: string, platform: string, arch: string, version: string): Promise<void>

  export function unpackMuon(packager: PlatformPackager<any>, out: string, platform: string, arch: string, version: string): Promise<void>
}
...
declare module "electron-builder/out/platformPackager" {
  import { Arch, FileAssociation, Platform, PlatformSpecificBuildOptions, Target, TargetSpecificOptions } from "electron-builder-core"
  import { AppInfo } from "electron-builder/out/appInfo"
  import { Config } from "electron-builder/out/metadata"
...
declare module "electron-builder/out/targets/license" {
  ...
  export function getLicenseFiles(packager: PlatformPackager<any>): Promise<Array<LicenseFile>>
...
declare module "electron-builder/out/targets/dmgLicense" {
  ...
  export function addLicenseToDmg(packager: PlatformPackager<any>, dmgPath: string): Promise<void>
}
...
declare module "electron-builder/out/targets/dmg" {
  ...
  export class DmgTarget extends Target {
    ...
    readonly options: DmgOptions | null | undefined
    private helperDir
...
declare module "electron-builder/out/publish/PublishManager" {
  import { Arch, PlatformSpecificBuildOptions } from "electron-builder-core"
  import { CancellationToken } from "electron-builder-http/out/CancellationToken"
  import { PublishConfiguration } from "electron-builder-http/out/publishOptions"
...
declare module "electron-builder/out/yarn" {
  ...
  export function installOrRebuild(config: Config, appDir: string, frameworkInfo: DesktopFrameworkInfo, platform: string, arch: string, forceInstall?: boolean): Promise<void>
  ...
  export function getGypEnv(frameworkInfo: DesktopFrameworkInfo, platform: string, arch: string, buildFromSource: boolean): any

  export function rebuild(appDir: string, frameworkInfo: DesktopFrameworkInfo, platform: string | undefined, arch: string | undefined, additionalArgs: Array<string>, buildFromSource: boolean): Promise<void>
}

declare module "electron-builder/out/packager" {
  /// <reference types="node" />
  import { Platform, SourceRepositoryInfo, Target } from "electron-builder-core"
  import { CancellationToken } from "electron-builder-http/out/CancellationToken"
  import { TmpDir } from "electron-builder-util/out/tmp"
...
declare module "electron-builder/out/forge/forge-maker" {
  ...
  export function buildForge(appDir: string, options: CliOptions): Promise<string[]>
}
...
declare module "electron-builder" {
  ...
  export { Metadata, Config, AfterPackContext } from "electron-builder/out/metadata"
  ...
  export { WinBuildOptions, NsisOptions, SquirrelWindowsOptions, AppXOptions, NsisWebOptions, PortableOptions } from "electron-builder/out/options/winOptions"
  export { LinuxBuildOptions, DebOptions, SnapOptions } from "electron-builder/out/options/linuxOptions"
