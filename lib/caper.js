...
var Co$ = {
    ...
    caperjs: {
        ...
        caper: {
            ...
            curvecountup: function (target, data) {
                console.error('will be released');
            },
            ...
            iternew: function (elem, data) {
                ...
                if (tar.length != value.length) value = Cp$.caperjs.random.string(tar.length);
    ...
    Typing: {
        ...
        english: function (elem, data) {
            ...
            if (data.type.length < 1) return 0;
            var value = data.startstring;
            console.log(elem);
            elem.innerHTML = value;
            ...
            function typeletter() {
                if (data.type.length < 1) return 1;
                var thiscycle = sec;
                switch (data.type[0]) {
                    ...
                    case '$sentence':
                        ...
                        var arraytheresult = [];
                        for (var i = 0; i < sentence.length; i++) arraytheresult.push(sentence[i]);
